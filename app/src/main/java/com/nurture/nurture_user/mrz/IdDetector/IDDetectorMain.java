package com.nurture.nurture_user.mrz.IdDetector;
        ...
        import com.nurture.nurture_user.mrz.R;

        import java.util.ArrayList;

public class IDDetectorMain extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iddetector_main);
    ...
    private Intent buildDetectorIntent(DetectorSettings detectorSettings) {
        ...
        intent.putExtra(DetectorActivity.EXTRAS_DETECTOR_SETTINGS,new DetectorSettings[]{detectorSettings});
        // pass license key
        intent.putExtra(DetectorActivity.EXTRAS_LICENSE_KEY, "MVJTCME3-5QCNBLEJ-VPO6IUGO-7KEKBMIN-OL2ZSN64-O5J5BLGJ-JKC3Q4KO-L4VMWTIE");
        return intent;
    }
